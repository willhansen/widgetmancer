...
impl Animation for BlinkAnimation {
    ...
    fn glyphs_at_time(&self, time: Instant) -> WorldCharacterSquareGlyphMap {
        ...
        let float_line_centered_on_start = modname::TwoDifferentPoints::new_from_two_points(
        ...
        let blink_line = modname::TwoDifferentPoints::new_from_two_points(start_point, end_point);
